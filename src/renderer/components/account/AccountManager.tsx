...
interface AccountManagerProps {
  /** Renders a close button in the header (used by the standalone modal). */
  onClose?: () => void
}

/**
 * Self-contained account list + add/edit form. Renders as a full-height
 * flex column, so it works both inside the settings modal and wrapped in a
...
export function AccountManager({ onClose }: AccountManagerProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <div className="flex h-[64px] shrink-0 items-center justify-between border-b border-white/70 px-5">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className="mt-0.5 block font-display text-xl text-sumi-text">
